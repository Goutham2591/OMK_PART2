...
class InteractionList(ListResource):
    ...
    def stream(self, inbound_participant_status=values.unset,
        ...
        :rtype: list[twilio.rest.preview.proxy.service.session.interaction.InteractionInstance]
        """
    ...
    def get(self, sid):
        ...
        :returns: twilio.rest.preview.proxy.service.session.interaction.InteractionContext
        :rtype: twilio.rest.preview.proxy.service.session.interaction.InteractionContext
        """
...
class InteractionPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio.rest.preview.proxy.service.session.interaction.InteractionPage
        :rtype: twilio.rest.preview.proxy.service.session.interaction.InteractionPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio.rest.preview.proxy.service.session.interaction.InteractionInstance
        :rtype: twilio.rest.preview.proxy.service.session.interaction.InteractionInstance
        """
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Preview.Proxy.InteractionPage>'
...
class InteractionContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Preview.Proxy.InteractionContext {}>'.format(context)
...
class InteractionInstance(InstanceResource):
    ...
    def status(self):
        ...
        :rtype: InteractionInstance.Status
        """
    ...
    def __repr__(self):
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Preview.Proxy.InteractionInstance {}>'.format(context)
