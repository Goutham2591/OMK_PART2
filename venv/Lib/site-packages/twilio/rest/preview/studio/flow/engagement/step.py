...
class StepList(ListResource):
    ...
    def stream(self, limit=None, page_size=None):
        ...
        :rtype: list[twilio.rest.preview.studio.flow.engagement.step.StepInstance]
        """
    ...
    def page(self, page_token=values.unset, page_number=values.unset,
        ...
        :rtype: twilio.rest.preview.studio.flow.engagement.step.StepPage
        """
    ...
    def get(self, sid):
        ...
        :returns: twilio.rest.preview.studio.flow.engagement.step.StepContext
        :rtype: twilio.rest.preview.studio.flow.engagement.step.StepContext
        """
        return StepContext(
            self._version,
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.Preview.Studio.StepList>'
...
class StepPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio.rest.preview.studio.flow.engagement.step.StepPage
        :rtype: twilio.rest.preview.studio.flow.engagement.step.StepPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio.rest.preview.studio.flow.engagement.step.StepInstance
        :rtype: twilio.rest.preview.studio.flow.engagement.step.StepInstance
        """
        return StepInstance(
            self._version,
            payload,
...
class StepContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        return '<Twilio.Preview.Studio.StepContext {}>'.format(context)
...
class StepInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Preview.Studio.StepInstance {}>'.format(context)
